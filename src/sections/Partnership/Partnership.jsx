      ...
      <div className="style-partnership">
        ...
        <div className="partnership-content">
          ...
          <div className="partnership-block">
            ...
            <p className="partnership-text">
              Durant la période que nous aurons préalablement défini ensemble,
              je m’investirai à 100% dans la réalisation de votre projet afin de
          ...
          <div className="partnership-block">
            ...
            <p className="partnership-text">
              Une fois ma première proposition présentée, vous pourrez
              m’exprimer vos différents retours et modifications souhaitées.
              Lorsque je vous aurez remis la version finale, un forfait de
              maintenance pourra être établi en fonction de votre demande.
            </p>
          </div>
        </div>
      </div>
