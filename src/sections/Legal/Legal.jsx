  ...
  return (
    <div id="legal">
      ...
      <div className="background-legal-white">
        ...
        <p>
          <strong>Propriétaire</strong> : Autoentrepreneur Justine Provent
          Capital social de 0€ – 9 rue de la Croix 90100 Fêche-l’Église
          <br />
          <strong>Responsable publication</strong> : Justine Provent –
        ...
        <p>
          ...
          le responsable du traitement des Données Personnelles est : Justine
          Provent.{" "}
          <a href="https://www.justineprovent.com">
            https://www.justineprovent.com
          </a>
        ...
        <ul>
          ...
          <li>
            ...
            automatisés fondés sur leur consentement ou sur un contrat (article
            20 RGPD){" "}
          </li>
        ...
        Justine Provent – DPO, Justine Provent <br />9 rue de la Croix 90100
        Fêche-l’Église.
        <p>
        ...
        <p>
          ...
          navigateur, qui permettra de savoir de quelle manière l’Utilisateur
        ...
        <p>
          ...
          les informations consultées), ainsi que l’utilisation de ce Site par
          l’Utilisateur.{" "}
        </p>
        <p>
